...
{
    private final int panelWidth = 100, panelHeight = 100, zoom = 6;
    
    private boolean isRandomlyGenerated;

    // nombre de fourmis dans la fourmilli�re
    private final static int NUMER_OF_ANTS = 3; 
    
    // nombre de cases nourriture initialement dans le cas ou g�n�ration al�atoire de terrain
    ...
    private int fileFoodQuantity; // quantit� de cases "nourriture" dans le fichier 
...
//	}
	...
	private int nbOfObstacles(Position p){
		// on suppose p comme �tant sur le terrain
	...
	private void initRand()
	{
		...
		// nourriture, plac�e en dehors des obstacles et de la base
	...
	/** @deprecated inutile car ne fait que mettre � z�ro les matrices de calcul, qui le sont d�ja par d�faut*/
...
//	----------------------------------------------
//	m�thodes pour utiliser la "Structure" Position
//	----------------------------------------------
	
	
	/* v�rifie qu'une position est bien sur le terrain 
...
//	
//	nb: j'ai rajout� les appels � la fonction de v�rification car Worker.getRelativePosition ne fait pas de v�rification
// 	� terme quand on fusionnera les deux m�thodes il n'y aura plus de double v�rification
